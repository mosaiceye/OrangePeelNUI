package orangepeel.kinect.utils
{
	...
	public class TransformSmoothing
	{
		...
		{
			this.clean(historyLength);
		}
		
		public function clean(historyLength:Number):void
		{
			this._history=new Vector.<Number>(historyLength, true);
			this._historyPoint=new Vector.<Point>(historyLength, true);
			this._historyVector3D=new Vector.<Vector3D>(historyLength, true);
		}
